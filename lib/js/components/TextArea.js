...
var TextArea = /** @class */ (function (_super) {
    ...
    TextArea.prototype.render = function () {
        ...
        return (React.createElement("div", { className: "mde-textarea-wrapper" },
            React.createElement(TextAreaComponent, __assign({ className: ClassNames_1.classNames("mde-text", classes), style: { height: height }, ref: this.props.refObject, onChange: this.handleOnChange, readOnly: readOnly, value: value, "data-testid": "text-area", onBlur: suggestionsEnabled ? this.handleBlur : undefined, onKeyDown: this.handleKeyDown, onKeyUp: suggestionsEnabled ? this.handleKeyUp : undefined, onKeyPress: suggestionsEnabled ? this.handleKeyPress : undefined, onPaste: onPaste }, textAreaProps)),
