...
- [Demo JSX on CodeSandbox](https://codesandbox.io/s/react-mde-latest-5i5ov?file=/src/index.js)
- [Demo TSX on CodeSandbox](https://codesandbox.io/s/react-typescript-i3wju?file=/src/index.tsx)
...
- **commands?: Record<string, Command>**: An object with string properties representing keys, and a Command object as value for each key. If no commands are specified, the default will be used. Commands are explained in more details below.
...
In order to determine which commands should be displayed
